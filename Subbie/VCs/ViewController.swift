...
// LATER: allow timing editing as text ? with validation using binding and value transformer ?
class ViewController: NSViewController {
    ...
    private let subtitleLineKind = NSPasteboard.PasteboardType(rawValue: "me.syan.Subbie.Line")
